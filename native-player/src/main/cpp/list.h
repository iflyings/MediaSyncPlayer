...
//
#ifndef MEDIASYNCPLAYER_LIST_H
#define MEDIASYNCPLAYER_LIST_H
 ...
 */
static inline void list_replace(struct list_head *old, struct list_head *replace)
{
...
static inline void list_replace_init(struct list_head *old,
                                     struct list_head *replace)
{
    list_replace(old, replace);
    INIT_LIST_HEAD(old);
}
